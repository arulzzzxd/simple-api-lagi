...
<head>
    ...
    <style>
        ...
        /* Custom arrow styling untuk dropdown select bahasa supaya konsisten minimalis */
...
<body class="min-h-screen antialiased">
    ...
    <div class="fixed top-4 right-4 z-50 flex items-center gap-2">
        <div class="relative">
            <select id="langSelect" class="lang-dropdown-select text-xs font-bold tracking-wider h-10 px-3 rounded-xl border border-slate-800 bg-[#0e1629] text-gray-400 light-mode:bg-white light-mode:border-gray-300 light-mode:text-gray-700 cursor-pointer focus:outline-none transition-all shadow-lg active:scale-95">
